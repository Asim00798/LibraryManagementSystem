...
{
    /// <inheritdoc />
    public partial class InitialCreateAndSeedMigrationData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BiographyExtended = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuthorDetails_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResidencyNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Residencies_Countries_CountryId",
                        column: x => x.CountryId,
                        principalTable: "Countries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Residencies_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorDetailId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authors_AuthorDetails_AuthorDetailId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalIdNumber = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Nationalities_People_PersonId",
                        column: x => x.PersonId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Nationalities_Residencies_ResidencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAuthors", x => new { x.BookTitleId, x.AuthorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityId = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
                    ...
                    ActionPerformedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditLogs_Users_ActionPerformedById",
                        column: x => x.ActionPerformedById,
                        principalSchema: "Security",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CopyStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfLateDays = table.Column<byte>(type: "tinyint", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagedByStaffId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shelves_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventStaff_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FineReason = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentLogs_Borrowings_BorrowingId",
                        column: x => x.BorrowingId,
                        principalTable: "Borrowings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PaymentLogs_Memberships_MembershipId",
                        column: x => x.MembershipId,
                        principalTable: "Memberships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PaymentLogs_PaymentLogs_ParentPaymentId",
                        column: x => x.ParentPaymentId,
                        principalTable: "PaymentLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentLogs_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.InsertData(
                table: "Countries",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DeletedAt", "DeletedBy", "ISOCode", "Name", "UpdatedAt", "UpdatedBy" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "US", "United States", null, null },
                    { new Guid("22222222-2222-2222-2222-222222222222"), new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "UK", "United Kingdom", null, null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "AE", "United Arab Emirates", null, null },
                    { new Guid("44444444-4444-4444-4444-444444444444"), new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "IN", "India", null, null },
                    { new Guid("55555555-5555-5555-5555-555555555555"), new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "PK", "Pakistan", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "English", null, null },
                    { 2, new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "Arabic", null, null },
                    { 3, new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "French", null, null },
                    { 4, new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "Hindi", null, null },
                    { 5, new DateTime(2025, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc), null, null, null, "Urdu", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ActionPerformedById",
                table: "AuditLogs",
                column: "ActionPerformedById");

            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_ActionPerformedByUserId",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorDetails_CountryId",
                table: "AuthorDetails",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Authors_AuthorDetailId",
                table: "Authors",
                column: "AuthorDetailId",
                unique: true,
                filter: "[AuthorDetailId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookAuthors_BookTitleId",
                table: "BookAuthors",
                column: "BookTitleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_ManagedByStaffId",
                table: "Branches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_PersonId_Type",
                table: "Contacts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Nationalities_PersonId",
                table: "Nationalities",
                column: "PersonId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Nationalities_ResidencyId",
                table: "Nationalities",
                column: "ResidencyId",
                unique: true,
                filter: "[ResidencyId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_BorrowingId",
                table: "PaymentLogs",
                column: "BorrowingId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_MembershipId",
                table: "PaymentLogs",
                column: "MembershipId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_ParentPaymentId",
                table: "PaymentLogs",
                column: "ParentPaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_PaymentStatus",
                table: "PaymentLogs",
                column: "PaymentStatus");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_PaymentType",
                table: "PaymentLogs",
                column: "PaymentType");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentLogs_SubscriptionId",
                table: "PaymentLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Residencies_CountryId",
                table: "Residencies",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Residencies_PersonId",
                table: "Residencies",
                column: "PersonId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Residencies_ResidencyNumber",
                table: "Residencies",
                column: "ResidencyNumber",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Branches_Staffs_ManagedByStaffId",
                table: "Branches",
                column: "ManagedByStaffId",
                principalTable: "Staffs",
                principalColumn: "Id");
